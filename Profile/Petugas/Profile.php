		...
		<div class="panel-body">
			...
			<div class="col-sm-6">
				...
				<center class="tooltip-demo">
					...
					<a data-toggle="tooltip" data-placement="right" title="Update Foto" href="home.php?page=ubah_foto&id_petugas=<?php echo $s['id_petugas'] ?>" class="btn btn-warning btn-md">
